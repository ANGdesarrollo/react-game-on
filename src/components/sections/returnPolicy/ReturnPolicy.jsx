        ...
        <section className="return-policy">
            ...
            <div className="description-return-policy">
                ...
                <ul>
                    ...
                    <li>The product corresponds to the detail of the invoice, but it is not what was requested in the
                        purchase order.
                    </li>
                    <li>The delivered product has manufacturing defects.</li>
                </ul>

                <p>Received and inspected the product, Game ON will have 10 calendar days to review it and verify if it
                    is
                    meet the preceding conditions to be the possible return, in which case it will initiate the
                    negotiations to credit the amount corresponding to the return of the amount paid by the User within
                    the
                    30 business days, except for delays not attributable to Game ON, such as those caused by entities
                    bank
                    and/or credit cards. The name and DNI and/or signature of the User at the time of delivery will be
                    sign of conformity on receipt and it will be understood that the Product is not damaged manifests or
